      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="detail"><div class="label">Job Name</div><div class="value">${job_name}</div></div>
            <div class="detail"><div class="label">Job ID</div><div class="value">${job_id}</div></div>
            <div class="detail"><div class="label">Status</div><div class="value" style="color: ${status === 'failed' ? '#ef4444' : '#22c55e'};">${status.toUpperCase()}</div></div>
            <div class="detail"><div class="label">Started</div><div class="value">${startFormatted} UTC</div></div>
            <div class="detail"><div class="label">Ended</div><div class="value">${endFormatted} UTC</div></div>
            ${error_message ? `<div class="error"><div class="label">Error Message</div><div style="margin-top: 8px; font-family: monospace; font-size: 13px; word-break: break-word;">${error_message}</div></div>` : ''}
            <a href="https://lovable.dev" class="button">View Dashboard</a>
            <div class="footer"><p>This is an automated message from Cat Farm's job monitoring system.</p></div>
          </div>
        </div>
      </body>
      </html>
