...
const makeState = (overrides: Partial<GameState> = {}): GameState => ({
  cats: [{ id: 'cat-1', name: 'Whiskers', type: 'stray', breed: 'tabby', health: 80, happiness: 70, hunger: 60, value: 80, age: 1, personality: 'playful', showWins: 0, isForSale: false, grade: 3, tricksLearned: [], trickProgress: {}, restLevel: 80, feedingScore: 50, lastTrainingDay: 0 }] as unknown as GameState['cats'],
  money: 500,
  space: 5,
  houseSize: 'apartment',
  acres: 0,
