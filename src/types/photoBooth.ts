...
export const PHOTO_BACKGROUNDS: PhotoBoothBackground[] = [
  // Nature
  { id: 'meadow', name: 'Sunny Meadow', category: 'nature', style: { background: 'linear-gradient(180deg, #87CEEB 0%, #90EE90 100%)' } },
  { id: 'starry', name: 'Starry Night', category: 'nature', style: { background: 'linear-gradient(180deg, #0f0c29 0%, #302b63 50%, #24243e 100%)' } },
  { id: 'sunset', name: 'Beach Sunset', category: 'nature', style: { background: 'linear-gradient(180deg, #ff7e5f 0%, #feb47b 50%, #ffdb99 100%)' } },
  { id: 'forest', name: 'Forest', category: 'nature', style: { background: 'linear-gradient(180deg, #134E5E 0%, #71B280 100%)' } },
  
  // Fantasy
  { id: 'rainbow', name: 'Rainbow Clouds', category: 'fantasy', style: { background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 25%, #4facfe 50%, #43e97b 75%, #f9d423 100%)' } },
  { id: 'galaxy', name: 'Space Galaxy', category: 'fantasy', style: { background: 'linear-gradient(180deg, #0f0c29 0%, #302b63 30%, #24243e 60%, #1a1a2e 100%)' } },
  { id: 'underwater', name: 'Underwater', category: 'fantasy', style: { background: 'linear-gradient(180deg, #1CB5E0 0%, #000851 100%)' } },
  { id: 'castle', name: 'Castle', category: 'fantasy', style: { background: 'linear-gradient(180deg, #667eea 0%, #764ba2 100%)' } },
  
  // Seasonal
  { id: 'spring', name: 'Spring Flowers', category: 'seasonal', style: { background: 'linear-gradient(180deg, #ffecd2 0%, #fcb69f 50%, #ee9ca7 100%)' } },
  { id: 'summer', name: 'Summer Sun', category: 'seasonal', style: { background: 'linear-gradient(180deg, #f6d365 0%, #fda085 100%)' } },
  { id: 'autumn', name: 'Autumn Leaves', category: 'seasonal', style: { background: 'linear-gradient(180deg, #e65c00 0%, #F9D423 100%)' } },
  { id: 'winter', name: 'Winter Snow', category: 'seasonal', style: { background: 'linear-gradient(180deg, #E0EAFC 0%, #CFDEF3 100%)' } },
  ...
  { id: 'gold', name: 'Gold', category: 'solid', style: { background: 'linear-gradient(135deg, #f9d423 0%, #ff4e50 100%)' } },
];
...
export const CAT_POSES: CatPose[] = [
  ...
  { id: 'bouncing', name: 'Bouncing', emoji: '🐈', transform: 'none', animation: 'animate-cat-bounce' },
];
