...
export function CatFarm() {
  ...
  return (
    <AnimatedBackground variant="game" className="min-h-screen">
      ...
      <Tabs
        value={ui.sideTab}
        onValueChange={ui.setSideTab}
        className={`flex-1 flex flex-col ${isMobile ? 'pb-16' : ''}`}
      >
        <div
          className={`sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border ${isMobile ? 'px-2' : 'px-4'} py-2`}
        >
          <CategoryTabBar
