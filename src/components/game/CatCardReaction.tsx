...
export function CatCardReaction({ reaction }: CatCardReactionProps) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 overflow-visible">
      ...
      <div className="absolute -top-2 -right-2 animate-emoji-pop" style={{ fontSize: '2rem' }}>
        <span
          className={`inline-block ${reaction.type === 'negative' ? 'animate-emoji-shake' : 'animate-emoji-wiggle'}`}
        >
          {reaction.emoji}
        </span>
      </div>
