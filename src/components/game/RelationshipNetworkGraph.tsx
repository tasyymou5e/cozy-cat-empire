    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Switch id="show-neutral" checked={showNeutral} onCheckedChange={setShowNeutral} />
          <Label htmlFor="show-neutral" className="text-xs">
            Show neutral
          </Label>
        </div>
      ...
      {/* Graph Container */}
      <div
        className="relative bg-secondary/20 rounded-lg border border-border overflow-hidden"
        style={{ height: 240 }}
      >
        ...
        >
          ...
          {visibleRelationships.map((rel) => {
            ...
            const isHighlighted =
              hoveredCatId && (rel.catId1 === hoveredCatId || rel.catId2 === hoveredCatId);
            const isHoveredLine =
        ...
        {nodePositions.map((pos) => {
          ...
          const avgScore =
            catRels.length > 0 ? catRels.reduce((sum, r) => sum + r.score, 0) / catRels.length : 0;
          ...
          return (
            ...
            >
              ...
              <p
                className={`text-[10px] text-center mt-0.5 font-medium truncate max-w-12 ${
        ...
        {hoveredRelationship && (
          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-popover border border-border rounded-lg p-2 shadow-lg z-30 text-xs animate-fade-in">
            <div className="flex items-center gap-2">
